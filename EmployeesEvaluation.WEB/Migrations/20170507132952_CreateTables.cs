        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserType = table.Column<int>(nullable: false, defaultValue: 3)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Disclosure = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EvaluationAssigned", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EvaluationAssigned_AspNetUsers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_EvaluationAssigned_Evaluations_EvaluationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EvaluationQuestion_Questions_QuestionId",
                        column: x => x.QuestionId,
                        principalTable: "Questions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EvaluationResponses_AspNetUsers_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    EvaluationResponseId = table.Column<int>(nullable: true),
                    FileName = table.Column<string>(nullable: true),
                    LikertAnswerId = table.Column<int>(nullable: false),
                    OpenEndedAnswer = table.Column<string>(nullable: true),
                    QuestionId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuestionAnswer_EvaluationResponses_EvaluationResponseId",
                        column: x => x.EvaluationResponseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationAssigned_EmployeeId",
                table: "EvaluationAssigned",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_EvaluationAssigned_EvaluationId",
                table: "EvaluationAssigned",
                column: "EvaluationId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EvaluationQuestion_QuestionId",
                table: "EvaluationQuestion",
                column: "QuestionId");

            migrationBuilder.CreateIndex(
                name: "IX_EvaluationResponses_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuestionAnswer_EvaluationResponseId",
                table: "QuestionAnswer",
                column: "EvaluationResponseId");

            migrationBuilder.CreateIndex(
                name: "IX_QuestionAnswer_LikertAnswerId",
                table: "QuestionAnswer",
                column: "LikertAnswerId");
